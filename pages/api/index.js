...
export const returnInboundWCS = (payload) =>
  api.post("/inbound/return/wcs", payload);
export const updateInboundWMS = (payload) =>
  api.post("/inbound/update/wms", payload);
export const updateInboundWMSREMARK = (payload) =>
  api.post("/inbound/update/wms/remark", payload);
...
export const searchInboundWMS = (payload) =>
  api.post("/inbound/search/wms", payload);
export const searchInboundWMSBynoSALE = () =>
  api.get("/inbound/search/wms/no/saleno");
...
export const shiftOutOnReturn = (data) =>
  api.post("/outboundExternal/shiftOutOnReturn", data, { timeout: 30000 });
export const updateStatusForOutboundCallCar = (data) =>
  api.post("/outboundExternal/updateStatusForOutboundCallCar", data);
export const clearNodePosGGROUP = (data) =>
  api.post("/outboundExternal/clearNodePosGGROUP", data);

/* 取得出庫單(領用) */
export const getOutboundInternal = () =>
  api.get("/outboundInternal/getOutboundInternal");
...
export const shiftOutOnReturnInternal = (data) =>
  api.post("/outboundInternal/shiftOutOnReturn", data, { timeout: 30000 });
export const updateStatusForOutboundCallCarInternal = (data) =>
  api.post("/outboundInternal/updateStatusForOutboundCallCar", data);
export const clearNodePosGGROUPInternal = (data) =>
  api.post("/outboundInternal/clearNodePosGGROUP", data);
...
/* 理貨 */
export const getShelfTransfer = (keyword) =>
  api.get("/shelfTransfer/getShelfTransfer", { params: { keyword } });
...
export const getRemarkByShelveIds = (shelveIds) =>
  api.get("/shelfTransfer/getRemarkByShelveIds", {
    params: { shelveIds: shelveIds.join(",") },
  });
export const updateRemark = (data) =>
  api.post("/shelfTransfer/updateRemark", data);
...
export const getOrder = (payload) =>
  api.get("/order/cmdid", { params: payload });
...
export const getOrderWave = (payload) => api.post("/order/erp_wave", payload);
export const getStationStatus = () => api.get("/order/stations_status");

/* 讀取WCS */

export const checkWCSLastCar = (payload) =>
  api.post("/wcs/check/lastcar", payload);
...
export const checkOrderDetail = (payload) =>
  api.post("/wcs/check/orderdetail", payload);
