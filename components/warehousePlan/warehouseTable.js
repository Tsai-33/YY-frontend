        ...
        <table className="w-full text-black font-bold border-collapse text-sm">
          <thead className="sticky top-0 bg-gray-100">
            <tr className="border-b-2 border-gray-300">
              <th className="px-2 py-2 text-center border-b border-gray-300 font-bold">倉別</th>
              <th className="px-2 py-2 text-center border-b border-gray-300 font-bold">貨架總數</th>
              <th className="px-2 py-2 text-center border-b border-gray-300 font-bold">位置區間</th>
            </tr>
          </thead>
          <tbody>
            {warehouseData.map((item, index) => (
              ...
              >
                ...
                <td className="px-2 py-1.5 text-left">
                  <span className={`font-bold text-xs ${getWarehouseColor(item.id)}`}>
