...
export default function Modal({ showModal, title, onClose, children, onConfirm, height, width }) {
      ...
      <div className={`rounded-[50px] bg-white border border-5 border-[var(--green-vivid)] overflow-hidden`} style={{ width: containerWidth, height: containerHeight }}>
        <div className="w-full h-full p-6 shadow-md flex flex-col justify-between items-center gap-8">
          ...
          <div className="relative w-full flex items-center justify-center">
            <div className="font-bold text-black text-[length:var(--font-size-6xl)]">{title}</div>
            <button
              ...
              onClick={onClose}
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" stroke="black" strokeWidth="4" fill="none" strokeLinecap="round">
